...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser('Setup a simulation for specific values of TOD and z_pos')
    parser.add_argument('--TOD', type=float, required=True, help='TOD in fs^3')
    parser.add_argument('--z_pos', type=float, required=True, help='z_pos in microns')
