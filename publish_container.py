...
def build_container(container: str, auto_yes: bool):
    ...
    command = f"docker build --platform linux/amd64 --provenance=false --output type=image,oci-mediatypes=true -t {imagename[container]} -f {folders[container]}.Dockerfile ."
