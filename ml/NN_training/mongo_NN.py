...
models_path = f'/global/homes/e/erod/2024_IFE-superfacility/ml/NN_training/saved_models/{model_type}/{experiment}'
...
with open(os.path.join(models_path, experiment+'.yml')) as f:
